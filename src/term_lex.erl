-file("c:/PROGRA~1/ERL59~1.1/lib/parsetools-2.0.7/include/leexinc.hrl", 0).
...
-file("src/term_lex.xrl", 11).

-file("c:/PROGRA~1/ERL59~1.1/lib/parsetools-2.0.7/include/leexinc.hrl", 14).
...
yystate(14, [10|Ics], Line, Tlen, _, _) ->
    yystate(14, Ics, Line+1, Tlen+1, 4, Tlen);
...
yystate(12, [100|Ics], Line, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(10, [123|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [44|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
...
yystate(5, [61|Ics], Line, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(5, [60|Ics], Line, Tlen, Action, Alen) ->
...
yyaction(3, TokenLen, YYtcs, _) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_3(TokenChars, TokenLen);
yyaction(4, _, _, _) ->
    yyaction_4();
yyaction(_, _, _, _) -> error.

-compile({inline,yyaction_0/2}).
-file("src/term_lex.xrl", 3).
yyaction_0(TokenChars, TokenLine) ->
     { token, { list_to_atom (string : strip (TokenChars, both, 39)), TokenLine } } .

-compile({inline,yyaction_1/2}).
-file("src/term_lex.xrl", 4).
yyaction_1(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_2/2}).
-file("src/term_lex.xrl", 5).
yyaction_2(TokenChars, TokenLine) ->
     { token, { 'COMPARISON', TokenLine, string : strip (TokenChars, both, 39) } } .

-compile({inline,yyaction_3/2}).
-file("src/term_lex.xrl", 6).
yyaction_3(TokenChars, TokenLen) ->
     { token, { 'NAME', TokenLen, string : strip (TokenChars, both, 34) } } .

-compile({inline,yyaction_4/0}).
-file("src/term_lex.xrl", 7).
yyaction_4() ->
     skip_token .

-file("c:/PROGRA~1/ERL59~1.1/lib/parsetools-2.0.7/include/leexinc.hrl", 282).
