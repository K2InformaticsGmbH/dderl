...
// Downloaded from https://6pac.github.io/SlickGrid/lib/jquery.event.drag-2.3.0.js
/*!
...
// Updated: 2017-04-13   Agustin Cautin
    ...
    var $event = $.event,
        ...
        drag = $special.drag = {
            ...
            add: function( obj ){
                ...
                $.each( drag.defaults, function( key ){
            ...
            hijack: function( event, type, dd, x, elem ){
                ...
                function handleInteractedElement(p, subject) {
                ...
                do {
                    ...
                    if ( ia ) {
                        ...
                        ia.results = [];
                        // handle each element
                        $( elem || ia[ mode ] || dd.droppable ).each(handleInteractedElement);
                        // flatten the results
